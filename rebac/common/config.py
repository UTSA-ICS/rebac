...
from rebac.version import version_info as version
...
paste_deploy_opts = [
    cfg.StrOpt('flavor',
               help=_('Partial name of a pipeline in your paste configuration '
                      ...
                      '[pipeline:rebac-api-keystone] use the value '
                      '"keystone"')),
...
def parse_cache_args(args=None):
    config_files = cfg.find_config_files(project='rebac', prog='rebac-cache')
